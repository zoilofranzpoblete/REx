                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="mr-3">
                                                    ...
                                                    $stmt = mysqli_query($conn,"SELECT * FROM productstbl WHERE stock > '20'");
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="mr-3">
                                                    ...
                                                    <div class="text-lg font-weight-bold"><?php
                                                    $stmt = mysqli_query($conn,"SELECT * FROM productstbl WHERE stock < '1'");
                            ...
                            <div class="card-header">Pharmacy List</div>
                                ...
                                <div class="datatable">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $result = mysqli_query($conn,"SELECT * FROM productstbl");
                                                $n = 1;
                                                while($row = mysqli_fetch_array($result)) {
                                            $image =  (!empty($row['productImage'])) ? '../images/'.$row['productImage'] : '../images/Rex-logo.png';
                                            ?>
                                            <tr class="display_product_details" data-id="<?php echo $row['productId']; ?>">
                                                <td><?php echo $n; ?></td>
                                                <td><img src='<?php echo $image; ?>' width='60px' height='60px' class="img-fluid"></td>
                                                <td><?php echo $row['brandName']; ?></td>
                                                <td><?php echo $row['price']; ?></td>
                                                <td><?php echo $row['stock']; ?></td>
                                                <td><?php 
                                                if($row['stock'] < 1){
                                                    echo '<div class="badge badge-danger badge-pill">Out of Stock</div>' ;
                                                }elseif($row['stock'] < 20){
                                                    echo '<div class="badge badge-warning badge-pill">Limited Stocks</div>';
                                                }else{
                                                    echo '<div class="badge badge-success badge-pill">Available</div>';
                                                } ?></td>
                                            </tr>
                                            <?php $n++; } ?>
                                        </tbody>
