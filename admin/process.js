...
$(document).on('click','#add_pharma_details',function(e) {
var name = $('#add_pharma_name').val();
var email = $('#add_pharma_email').val();
var confirm_email = $('#confirm_email').val();
var number = $('#add_pharma_contact').val();
var address = $('#add_pharma_address').val();
var barangay = $('#add_pharma_barangay').val();
var city = $('#add_pharma_city').val();
var province = $('#add_pharma_province').val();
var subscription = $('#add_pharma_subs').val();
var start = $('#add_pharma_start').val();
var end = $('#add_pharma_end').val();
var username = $('#add_pharma_username').val();
var password = $('#add_pharma_password').val();
	...
	if(email != confirm_email){
		...
		if(password != confirm_password){
			...
			$.ajax({
				...
				url: "action.php",
				beforeSend: function () {
					$("#add_pharma_details").html("<i class='fas fa-spinner fa-spin'></i>&nbsp;Processing");
					$("#add_pharma_details").prop('disabled', true);
				},
				success: function(dataResult){
					var dataResult = JSON.parse(dataResult);
					if(dataResult.statusCode==200){
						Swal.fire({
							icon: 'success',
							text: 'New Pharmacy Record added successfully! ',
						}).then(function(){
							location.reload();
						}, 2000);
					}else if(dataResult.statusCode==201){
						Swal.fire({
							...
							$("#add_pharma_details").html("<i data-feather='save'></i>&nbsp;Save");
							$("#add_pharma_details").prop('disabled', false); });
					}
				}
			});
