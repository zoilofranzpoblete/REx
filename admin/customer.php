                            ...
                            <div class="card-header">Customer List</div>
                                ...
                                <div class="datatable">
                                    <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            <?php
                                                $result = mysqli_query($conn,"SELECT * FROM customertbl");
                                                $n = 1;
                                                while($row = mysqli_fetch_array($result)) {
                                            $image = 'assets/img/illustrations/profiles/profile-1.png';
                                            ?>
                                            <tr class="display_details" data-id="<?php echo $row['customerId']; ?>">
                                                <td><?php echo $n; ?></td>
                                                ...
                                                <td><button class="btn btn-datatable btn-icon btn-transparent-dark" title="Delete" id="delete_customer" data-id='<?php echo $row['customerId']; ?>'><i data-feather="trash-2"></i></button></td>
                                            </tr>
                                            <?php $n++; } ?>
                                        </tbody>
                                    </table>
