                ...
                <main>
                    ...
                    <div class="row">
                                ...
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body overflow-auto">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="mr-3">
                                                <div class="text-white-75 small">Pharmacies</div>
                                                <div class="text-lg font-weight-bold">0</div>
                                            </div>
                                            <i class="feather-xl text-white-50 fas fa-hospital"></i>
                                        </div>
                                    </div>
                                ...
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <i class="feather-xl text-white-50 fas fa-user-friends"></i>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between"></div>
                                </div>
                                ...
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <i class="feather-xl text-white-50 fas fa-shopping-cart"></i>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between"></div>
                                </div>
                            ...
                            <div class="col-xxl-3 col-lg-3">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="mr-3">
                                                <div class="text-white-75 small">Feedback/Reports</div>
                                                <div class="text-lg font-weight-bold"><?php echo "0" //$for_approval; ?></div>
                                            </div>
                                            <i class="feather-xl text-white-50 fas fa-comments"></i>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between"></div>
                                </div>
                            ...
                            <!-- <div class="col-xxl-8 col-xl-8 mb-8">
                                <div class="card card-header-actions h-100" style="max-height: 450px;">
                                    <div class="card-header">Total Earnings (All Pharmacies)</div>
                                    <div class="card-body overflow-auto">
