        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <h1>Welcome To</h1>
              <img src="../images/rex-banner.png" alt="REx Logo" class="bg-logo"/>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12 block-3 products-wrap">
            ...
            <div class="text-center mt-2"><a href="pharmacy.php" class="btn btn-black text-center px-5 py-3">View all pharmacy</a></div>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="banner-1 h-100 d-flex" >
              ...
              <h2>Contact Info</h2>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" id="report_submit" class="btn btn-black btn-lg btn-block" value="Send Message">
                  </div>
                </div>
                </p>
              </div>
