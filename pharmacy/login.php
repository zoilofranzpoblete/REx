                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-2 rounded-lg mt-5 border-info" style="margin-top: 17em !important;">
                                    <div class="card-header justify-content-center bg-primary-soft"  style="background-image: url('../images/bg_1.jpg'); background-position-y: 50%;background-size: cover;">
                                        <div class="row">
                                            <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-8">
                                                 <p class="text-dark text-uppercase my-2 mt-5" style="font-size: 20px;"><b>REx - Pharmacy<br> Login</b></p>
                                    ...
                                    <div class="card-footer ">
                                        <div class="row" >
                                            <div class="col-lg-6 text-left"><a href="#">Register Here!</a></div>
